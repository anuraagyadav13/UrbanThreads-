...
export default function Slider({ slides }) {
  ...
  return (
    <div className="w-full h-[80vh] relative flex justify-center overflow-hidden">
      ...
      <span className="absolute rounded-full bg-black/40 dark:bg-zinc-800/60 flex justify-center items-center bottom-6 left-6 z-10 cursor-pointer text-white p-2">
	    	<ChevronLeft width={48} height={48} onClick={prevSlide} />
      </span>
      <span className="absolute rounded-full bg-black/40 dark:bg-zinc-800/60 flex justify-center items-center bottom-6 right-6 z-10 cursor-pointer text-white p-2">
